...
router.put("/:reservationId/reschedule", reservationController.rescheduleReservation);
router.put("/:reservationId/cancel", reservationController.cancelReservation);
router.get("/:reservationId/history", reservationController.getReservationHistory);
