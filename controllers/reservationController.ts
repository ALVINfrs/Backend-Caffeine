...
// Get available rooms
async function getAvailableRooms(req: Request, res: Response): Promise<Response> {
    try {
...
// Create reservation
async function createReservation(req: Request, res: Response): Promise<Response> {
    const {
        customerName,
        email,
        phone,
...
async function getReservationByNumber(req: Request, res: Response): Promise<Response> {
...
async function getUserReservations(req: Request, res: Response): Promise<Response> {
...
async function rescheduleReservation(req: Request, res: Response): Promise<Response> {
...
// Cancel reservation
async function cancelReservation(req: Request, res: Response): Promise<Response> {
    const { reservationId } = req.params;
...
async function getReservationHistory(req: Request, res: Response): Promise<Response> {
    const { reservationId } = req.params;
